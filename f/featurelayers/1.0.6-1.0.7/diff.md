# Comparing `tmp/featurelayers-1.0.6.tar.gz` & `tmp/featurelayers-1.0.7.tar.gz`
...
## Comparing `featurelayers-1.0.6.tar` & `featurelayers-1.0.7.tar`
...
### Comparing `featurelayers-1.0.6/featurelayers/layers/LBC.py` & `featurelayers-1.0.7/featurelayers/layers/LBC.py`

 * *Files identical despite different names*

### Comparing `featurelayers-1.0.6/featurelayers.egg-info/SOURCES.txt` & `featurelayers-1.0.7/featurelayers.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `featurelayers-1.0.6/setup.py` & `featurelayers-1.0.7/setup.py`

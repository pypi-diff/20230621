# Comparing `tmp/pysailfish-1.5.0.tar.gz` & `tmp/pysailfish-1.6.0.tar.gz`
...
### Comparing `pysailfish-1.5.0/pysailfish/app/EAs/MA_EA.py` & `pysailfish-1.6.0/pysailfish/app/EAs/MA_EA.py`

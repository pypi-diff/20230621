# Comparing `tmp/pyscemu-0.2.4.tar.gz` & `tmp/pyscemu-0.2.5.tar.gz`

## Comparing `pyscemu-0.2.4.tar` & `pyscemu-0.2.5.tar`
...
### Comparing `pyscemu-0.2.4/.github/workflows/CI.yml` & `pyscemu-0.2.5/.github/workflows/CI.yml`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/.gitignore` & `pyscemu-0.2.5/.gitignore`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/DOCUMENTATION.md` & `pyscemu-0.2.5/DOCUMENTATION.md`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/README.md` & `pyscemu-0.2.5/README.md`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/danabot_rsa.ipynb` & `pyscemu-0.2.5/examples/danabot_rsa.ipynb`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/raccoon_strings.ipynb` & `pyscemu-0.2.5/examples/raccoon_strings.ipynb`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/scripts/raccoon_strings.py` & `pyscemu-0.2.5/examples/scripts/raccoon_strings.py`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/scripts/test.py` & `pyscemu-0.2.5/examples/scripts/test.py`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/scripts/xloader_dexor.py` & `pyscemu-0.2.5/examples/scripts/xloader_dexor.py`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/examples/xloader_keygen.ipynb` & `pyscemu-0.2.5/examples/xloader_keygen.ipynb`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/src/lib.rs` & `pyscemu-0.2.5/src/lib.rs`

 * *Files identical despite different names*

### Comparing `pyscemu-0.2.4/Cargo.lock` & `pyscemu-0.2.5/Cargo.lock`
...
### Comparing `pyscemu-0.2.4/PKG-INFO` & `pyscemu-0.2.5/PKG-INFO`

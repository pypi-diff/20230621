# Comparing `tmp/hmfs-1.1.5145.tar.gz` & `tmp/hmfs-1.1.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/hmfs-1.1.5145.tar", last modified: Tue Jun 20 03:10:24 2023, max compression
+gzip compressed data, was "dist/hmfs-1.1.6.tar", last modified: Wed Aug 24 12:07:38 2022, max compression
```

## Comparing `hmfs-1.1.5145.tar` & `hmfs-1.1.6.tar`

### file list

```diff
@@ -1,41 +1,1134 @@
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-06-20 03:10:24.000000 hmfs-1.1.5145/PKG-INFO
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2022-10-12 00:41:11.000000 hmfs-1.1.5145/hamunafs/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/backends/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      203 2022-08-24 10:45:13.000000 hmfs-1.1.5145/hamunafs/backends/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1057 2023-06-20 02:52:00.000000 hmfs-1.1.5145/hamunafs/backends/base.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4042 2023-06-17 01:27:26.000000 hmfs-1.1.5145/hamunafs/backends/bk_minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4374 2023-06-17 01:26:51.000000 hmfs-1.1.5145/hamunafs/backends/bk_qiniu.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1233 2023-04-07 02:55:40.000000 hmfs-1.1.5145/hamunafs/backends/bk_share.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5771 2023-06-17 01:27:12.000000 hmfs-1.1.5145/hamunafs/backends/bk_wy.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     1530 2023-06-20 02:47:09.000000 hmfs-1.1.5145/hamunafs/backends/fetcher.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    20798 2023-06-20 03:00:22.000000 hmfs-1.1.5145/hamunafs/client.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      189 2021-11-18 09:55:13.000000 hmfs-1.1.5145/hamunafs/conf.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/net/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 08:04:57.000000 hmfs-1.1.5145/hamunafs/net/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     3969 2023-04-07 03:25:41.000000 hmfs-1.1.5145/hamunafs/net/api.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     8979 2023-06-20 02:58:16.000000 hmfs-1.1.5145/hamunafs/server.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/sqlite/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4895 2021-11-17 08:14:48.000000 hmfs-1.1.5145/hamunafs/sqlite/__init__.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/tuchuang/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2023-04-07 08:04:51.000000 hmfs-1.1.5145/hamunafs/tuchuang/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4126 2023-04-07 07:50:22.000000 hmfs-1.1.5145/hamunafs/tuchuang/tucang.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hamunafs/utils/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        0 2022-10-12 00:41:11.000000 hmfs-1.1.5145/hamunafs/utils/__init__.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5300 2022-05-20 12:24:19.000000 hmfs-1.1.5145/hamunafs/utils/cachemanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     4578 2022-10-20 11:01:55.000000 hmfs-1.1.5145/hamunafs/utils/img_compressor.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     6928 2023-05-19 17:06:09.000000 hmfs-1.1.5145/hamunafs/utils/minio.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     3579 2022-08-24 10:04:27.000000 hmfs-1.1.5145/hamunafs/utils/mqtt.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)     5226 2023-02-03 04:48:33.000000 hmfs-1.1.5145/hamunafs/utils/nsqmanager.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)    17412 2023-05-11 12:24:08.000000 hmfs-1.1.5145/hamunafs/utils/redisutil.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      633 2023-01-28 07:26:26.000000 hmfs-1.1.5145/hamunafs/utils/singleton_wrapper.py
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      932 2022-09-03 07:57:02.000000 hmfs-1.1.5145/hamunafs/utils/timeutil.py
-drwxrwxr-x   0 superpigy  (1000) superpigy  (1000)        0 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      330 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/PKG-INFO
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      864 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/SOURCES.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        1 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/dependency_links.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      141 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/requires.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)        9 2023-06-20 03:10:24.000000 hmfs-1.1.5145/hmfs.egg-info/top_level.txt
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)       38 2023-06-20 03:10:24.000000 hmfs-1.1.5145/setup.cfg
--rw-rw-r--   0 superpigy  (1000) superpigy  (1000)      723 2023-06-20 03:10:21.000000 hmfs-1.1.5145/setup.py
...
### Comparing `hmfs-1.1.5145/hamunafs/backends/bk_minio.py` & `hmfs-1.1.6/hamunafs/backends/bk_minio.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/backends/bk_wy.py` & `hmfs-1.1.6/hamunafs/backends/bk_qiniu.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/client.py` & `hmfs-1.1.6/hamunafs/client.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/server.py` & `hmfs-1.1.6/hamunafs/server.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/sqlite/__init__.py` & `hmfs-1.1.6/hamunafs/sqlite/__init__.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5145/hamunafs/utils/cachemanager.py` & `hmfs-1.1.6/hamunafs/utils/cachemanager.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5145/hamunafs/utils/minio.py` & `hmfs-1.1.6/hamunafs/utils/minio.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/utils/mqtt.py` & `hmfs-1.1.6/hamunafs/utils/mqtt.py`

 * *Files identical despite different names*

### Comparing `hmfs-1.1.5145/hamunafs/utils/nsqmanager.py` & `hmfs-1.1.6/hamunafs/utils/nsqmanager.py`
...
### Comparing `hmfs-1.1.5145/hamunafs/utils/redisutil.py` & `hmfs-1.1.6/hamunafs/utils/redisutil.py`
...
### Comparing `hmfs-1.1.5145/setup.py` & `hmfs-1.1.6/setup.py`

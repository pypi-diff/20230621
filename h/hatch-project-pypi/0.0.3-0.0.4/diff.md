# Comparing `tmp/hatch_project_pypi-0.0.3.tar.gz` & `tmp/hatch_project_pypi-0.0.4.tar.gz`

## Comparing `hatch_project_pypi-0.0.3.tar` & `hatch_project_pypi-0.0.4.tar`
...
### Comparing `hatch_project_pypi-0.0.3/LICENSE.txt` & `hatch_project_pypi-0.0.4/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `hatch_project_pypi-0.0.3/README.md` & `hatch_project_pypi-0.0.4/README.md`

 * *Files identical despite different names*

### Comparing `hatch_project_pypi-0.0.3/pyproject.toml` & `hatch_project_pypi-0.0.4/pyproject.toml`

 * *Files identical despite different names*

### Comparing `hatch_project_pypi-0.0.3/PKG-INFO` & `hatch_project_pypi-0.0.4/PKG-INFO`

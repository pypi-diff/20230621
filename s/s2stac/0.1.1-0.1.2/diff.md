# Comparing `tmp/s2stac-0.1.1.tar.gz` & `tmp/s2stac-0.1.2.tar.gz`
...
+gzip compressed data, was "s2stac-0.1.2.tar", max compression
```

## Comparing `s2stac-0.1.1.tar` & `s2stac-0.1.2.tar`
...
+-rw-r--r--   0        0        0     1071 2023-05-12 11:45:52.630479 s2stac-0.1.2/LICENSE
+-rw-r--r--   0        0        0     3922 2023-06-09 14:47:23.109769 s2stac-0.1.2/README.md
+-rw-r--r--   0        0        0      921 2023-06-21 13:46:09.772515 s2stac-0.1.2/pyproject.toml
+-rw-r--r--   0        0        0      257 2023-06-02 14:18:31.109651 s2stac-0.1.2/src/s2stac/__init__.py
+-rw-r--r--   0        0        0     1547 2023-06-02 14:01:10.199802 s2stac-0.1.2/src/s2stac/_asset.py
+-rw-r--r--   0        0        0     2083 2023-06-02 14:04:14.981564 s2stac-0.1.2/src/s2stac/_aux_data.py
+-rw-r--r--   0        0        0     6300 2023-06-09 14:34:47.515390 s2stac-0.1.2/src/s2stac/_catalog.py
+-rw-r--r--   0        0        0     1897 2023-06-02 14:12:37.734322 s2stac-0.1.2/src/s2stac/_img_data.py
+-rw-r--r--   0        0        0     8005 2023-06-12 15:58:47.760733 s2stac-0.1.2/src/s2stac/_mtd_tl.py
+-rw-r--r--   0        0        0     2147 2023-06-02 13:07:54.221429 s2stac-0.1.2/src/s2stac/_preview.py
+-rw-r--r--   0        0        0     5299 2023-06-12 16:11:47.744852 s2stac-0.1.2/src/s2stac/_qi_data.py
+-rw-r--r--   0        0        0     9297 2023-06-12 10:00:04.730983 s2stac-0.1.2/src/s2stac/_srtm.py
+-rw-r--r--   0        0        0     1768 2023-06-12 12:20:49.684033 s2stac-0.1.2/src/s2stac/_stacify.py
+-rw-r--r--   0        0        0     5275 1970-01-01 00:00:00.000000 s2stac-0.1.2/setup.py
+-rw-r--r--   0        0        0     5132 1970-01-01 00:00:00.000000 s2stac-0.1.2/PKG-INFO
```

### Comparing `s2stac-0.1.1/LICENSE` & `s2stac-0.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/pyproject.toml` & `s2stac-0.1.2/pyproject.toml`
...
### Comparing `s2stac-0.1.1/src/s2stac/_asset.py` & `s2stac-0.1.2/src/s2stac/_asset.py`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/src/s2stac/_aux_data.py` & `s2stac-0.1.2/src/s2stac/_aux_data.py`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/src/s2stac/_catalog.py` & `s2stac-0.1.2/src/s2stac/_catalog.py`
...
### Comparing `s2stac-0.1.1/src/s2stac/_img_data.py` & `s2stac-0.1.2/src/s2stac/_img_data.py`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/src/s2stac/_mtd_tl.py` & `s2stac-0.1.2/src/s2stac/_mtd_tl.py`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/src/s2stac/_preview.py` & `s2stac-0.1.2/src/s2stac/_preview.py`

 * *Files identical despite different names*

### Comparing `s2stac-0.1.1/src/s2stac/_qi_data.py` & `s2stac-0.1.2/src/s2stac/_qi_data.py`
...
### Comparing `s2stac-0.1.1/src/s2stac/_stacify.py` & `s2stac-0.1.2/src/s2stac/_stacify.py`

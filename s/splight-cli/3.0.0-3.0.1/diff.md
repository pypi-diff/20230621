# Comparing `tmp/splight-cli-3.0.0.tar.gz` & `tmp/splight-cli-3.0.1.tar.gz`
...
### Comparing `splight-cli-3.0.0/cli/engine/manager/exceptions.py` & `splight-cli-3.0.1/cli/engine/manager/exceptions.py`

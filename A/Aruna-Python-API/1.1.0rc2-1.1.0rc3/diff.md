# Comparing `tmp/Aruna-Python-API-1.1.0rc2.tar.gz` & `tmp/Aruna-Python-API-1.1.0rc3.tar.gz`
...
## Comparing `Aruna-Python-API-1.1.0rc2.tar` & `Aruna-Python-API-1.1.0rc3.tar`
...
### Comparing `Aruna-Python-API-1.1.0rc2/Aruna_Python_API.egg-info/PKG-INFO` & `Aruna-Python-API-1.1.0rc3/Aruna_Python_API.egg-info/PKG-INFO`
...
### Comparing `Aruna-Python-API-1.1.0rc2/Aruna_Python_API.egg-info/SOURCES.txt` & `Aruna-Python-API-1.1.0rc3/Aruna_Python_API.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/LICENSE` & `Aruna-Python-API-1.1.0rc3/LICENSE`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/PKG-INFO` & `Aruna-Python-API-1.1.0rc3/PKG-INFO`
...
### Comparing `Aruna-Python-API-1.1.0rc2/README.md` & `Aruna-Python-API-1.1.0rc3/README.md`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/authorize_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/authorize_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/authorize_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/authorize_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/authorize_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/authorize_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/bundler_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/bundler_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/bundler_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/bundler_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/bundler_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/bundler_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/notification_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/notification_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/notification_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/notification_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/notification_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/notification_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/proxy_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/proxy_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/proxy_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/proxy_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/internal/v1/proxy_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/internal/v1/proxy_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/notification/services/v1/notification_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/notification/services/v1/notification_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/notification/services/v1/notification_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/notification/services/v1/notification_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/notification/services/v1/notification_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/notification/services/v1/notification_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/auth_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/auth_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/auth_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/auth_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/models_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/models_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/models_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/models_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/query_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/query_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/models/v1/query_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/models/v1/query_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/collection_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/collection_service_pb2.pyi`
...
### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/endpoint_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/endpoint_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/endpoint_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/endpoint_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/endpoint_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/endpoint_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/info_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/info_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/info_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/info_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/info_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/info_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/object_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/object_service_pb2.py`
...
@@ -70,14 +70,16 @@
   ...
   _OBJECTSERVICE.methods_by_name['SetObjectPathVisibility']._serialized_options = b'\202\323\344\223\002=:\001*28/v1/collection/{collection_id}/path/{path=**}/visibility'
   _OBJECTSERVICE.methods_by_name['GetObjectsByPath']._options = None
   _OBJECTSERVICE.methods_by_name['GetObjectsByPath']._serialized_options = b'\202\323\344\223\002\033\022\031/v1/path/object/{path=**}'
   _OBJECTSERVICE.methods_by_name['GetProjectCollectionIdsByPath']._options = None
   _OBJECTSERVICE.methods_by_name['GetProjectCollectionIdsByPath']._serialized_options = b'\202\323\344\223\002\037\022\035/v1/path/collection/{path=**}'
+  _OBJECTSERVICE.methods_by_name['GetObjectsAsListV2']._options = None
+  _OBJECTSERVICE.methods_by_name['GetObjectsAsListV2']._serialized_options = b'\202\323\344\223\002\031\022\027/v1/path/objects/listv2'
...
### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/object_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/object_service_pb2.pyi`
...
### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/object_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/object_service_pb2_grpc.py`
...
+        self.GetObjectsAsListV2 = channel.unary_unary(
+                '/aruna.api.storage.services.v1.ObjectService/GetObjectsAsListV2',
+                request_serializer=aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Request.SerializeToString,
+                response_deserializer=aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Response.FromString,
+                )
...
+            'GetObjectsAsListV2': grpc.unary_unary_rpc_method_handler(
+                    servicer.GetObjectsAsListV2,
+                    request_deserializer=aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Request.FromString,
+                    response_serializer=aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Response.SerializeToString,
+            ),
     }
...
+
+    @staticmethod
+    def GetObjectsAsListV2(request,
+            target,
+            options=(),
...
+            timeout=None,
+            metadata=None):
+        return grpc.experimental.unary_unary(request, target, '/aruna.api.storage.services.v1.ObjectService/GetObjectsAsListV2',
+            aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Request.SerializeToString,
+            aruna_dot_api_dot_storage_dot_services_dot_v1_dot_object__service__pb2.GetObjectsAsListV2Response.FromString,
+            options, channel_credentials,
+            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
```

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/objectgroup_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/objectgroup_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/objectgroup_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/objectgroup_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/objectgroup_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/objectgroup_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/project_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/project_service_pb2.py`
...
### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/project_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/project_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/project_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/project_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/service_account_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/service_account_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/service_account_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/service_account_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/service_account_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/service_account_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/user_service_pb2.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/user_service_pb2.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/user_service_pb2.pyi` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/user_service_pb2.pyi`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/aruna/api/storage/services/v1/user_service_pb2_grpc.py` & `Aruna-Python-API-1.1.0rc3/aruna/api/storage/services/v1/user_service_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `Aruna-Python-API-1.1.0rc2/setup.py` & `Aruna-Python-API-1.1.0rc3/setup.py`

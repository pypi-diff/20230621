# Comparing `tmp/Telexy.MARS-1.23.626.tar.gz` & `tmp/Telexy.MARS-1.23.628.tar.gz`
...
## Comparing `Telexy.MARS-1.23.626.tar` & `Telexy.MARS-1.23.628.tar`
...
### Comparing `Telexy.MARS-1.23.626/LICENSE.txt` & `Telexy.MARS-1.23.628/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `Telexy.MARS-1.23.626/setup.py` & `Telexy.MARS-1.23.628/setup.py`

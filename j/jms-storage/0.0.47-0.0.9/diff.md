# Comparing `tmp/jms-storage-0.0.47.tar.gz` & `tmp/jms-storage-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jms-storage-0.0.47.tar", last modified: Wed Jun 21 08:18:58 2023, max compression
+gzip compressed data, was "dist/jms-storage-0.0.9.tar", last modified: Thu Mar  8 16:18:39 2018, max compression
```

## Comparing `jms-storage-0.0.47.tar` & `jms-storage-0.0.9.tar`

### file list

```diff
@@ -1,29 +1,17 @@
-drwxr-xr-x   0 guang      (501) staff       (20)        0 2023-06-21 08:18:58.913147 jms-storage-0.0.47/
--rw-r--r--   0 guang      (501) staff       (20)     1213 2023-06-21 08:12:20.000000 jms-storage-0.0.47/.gitignore
--rw-r--r--   0 guang      (501) staff       (20)      651 2023-06-21 08:18:58.913040 jms-storage-0.0.47/PKG-INFO
--rw-r--r--   0 guang      (501) staff       (20)       25 2023-06-21 08:12:20.000000 jms-storage-0.0.47/README.md
--rwxr-xr-x   0 guang      (501) staff       (20)      164 2023-06-21 08:12:20.000000 jms-storage-0.0.47/build.sh
-drwxr-xr-x   0 guang      (501) staff       (20)        0 2023-06-21 08:18:58.912287 jms-storage-0.0.47/jms_storage/
--rw-r--r--   0 guang      (501) staff       (20)     1331 2023-06-21 08:18:10.000000 jms-storage-0.0.47/jms_storage/__init__.py
--rw-r--r--   0 guang      (501) staff       (20)     1721 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/azure.py
--rw-r--r--   0 guang      (501) staff       (20)     1134 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/base.py
--rw-r--r--   0 guang      (501) staff       (20)     1936 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/ceph.py
--rw-r--r--   0 guang      (501) staff       (20)     5372 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/es.py
--rw-r--r--   0 guang      (501) staff       (20)     3494 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/ftp.py
--rw-r--r--   0 guang      (501) staff       (20)     1375 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/jms.py
--rw-r--r--   0 guang      (501) staff       (20)     1705 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/multi.py
--rw-r--r--   0 guang      (501) staff       (20)     2385 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/obs.py
--rw-r--r--   0 guang      (501) staff       (20)     1621 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/oss.py
--rw-r--r--   0 guang      (501) staff       (20)     2235 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/s3.py
--rw-r--r--   0 guang      (501) staff       (20)     1725 2023-06-21 08:12:20.000000 jms-storage-0.0.47/jms_storage/storage_test.py
-drwxr-xr-x   0 guang      (501) staff       (20)        0 2023-06-21 08:18:58.912783 jms-storage-0.0.47/jms_storage.egg-info/
--rw-r--r--   0 guang      (501) staff       (20)      651 2023-06-21 08:18:58.000000 jms-storage-0.0.47/jms_storage.egg-info/PKG-INFO
--rw-r--r--   0 guang      (501) staff       (20)      498 2023-06-21 08:18:58.000000 jms-storage-0.0.47/jms_storage.egg-info/SOURCES.txt
--rw-r--r--   0 guang      (501) staff       (20)        1 2023-06-21 08:18:58.000000 jms-storage-0.0.47/jms_storage.egg-info/dependency_links.txt
--rw-r--r--   0 guang      (501) staff       (20)      301 2023-06-21 08:18:58.000000 jms-storage-0.0.47/jms_storage.egg-info/requires.txt
--rw-r--r--   0 guang      (501) staff       (20)       12 2023-06-21 08:18:58.000000 jms-storage-0.0.47/jms_storage.egg-info/top_level.txt
--rw-r--r--   0 guang      (501) staff       (20)      301 2023-06-21 08:12:40.000000 jms-storage-0.0.47/requirements.txt
--rw-r--r--   0 guang      (501) staff       (20)       38 2023-06-21 08:18:58.913181 jms-storage-0.0.47/setup.cfg
--rw-r--r--   0 guang      (501) staff       (20)     1462 2023-06-21 08:12:20.000000 jms-storage-0.0.47/setup.py
-drwxr-xr-x   0 guang      (501) staff       (20)        0 2023-06-21 08:18:58.912882 jms-storage-0.0.47/utils/
--rw-r--r--   0 guang      (501) staff       (20)      745 2023-06-21 08:12:20.000000 jms-storage-0.0.47/utils/sync_req_core.py
...
### Comparing `jms-storage-0.0.47/jms_storage/ceph.py` & `jms-storage-0.0.9/jms_storage/aws.py`
...
### Comparing `jms-storage-0.0.47/jms_storage/jms.py` & `jms-storage-0.0.9/jms_storage/ali.py`
...
### Comparing `jms-storage-0.0.47/setup.py` & `jms-storage-0.0.9/setup.py`

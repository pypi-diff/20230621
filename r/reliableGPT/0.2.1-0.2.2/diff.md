# Comparing `tmp/reliableGPT-0.2.1.tar.gz` & `tmp/reliableGPT-0.2.2.tar.gz`
...
## Comparing `reliableGPT-0.2.1.tar` & `reliableGPT-0.2.2.tar`
...
### Comparing `reliableGPT-0.2.1/LICENSE` & `reliableGPT-0.2.2/LICENSE`

 * *Files identical despite different names*

### Comparing `reliableGPT-0.2.1/README.md` & `reliableGPT-0.2.2/README.md`

 * *Files identical despite different names*

### Comparing `reliableGPT-0.2.1/reliablegpt/main.py` & `reliableGPT-0.2.2/reliablegpt/main.py`

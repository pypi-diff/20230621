# Comparing `tmp/expectise-1.2.3.tar.gz` & `tmp/expectise-1.2.4.tar.gz`
...
+gzip compressed data, was "dist/expectise-1.2.4.tar", last modified: Wed Jun 21 08:04:05 2023, max compression
```

## Comparing `expectise-1.2.3.tar` & `expectise-1.2.4.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-21 08:04:05.540350 expectise-1.2.4/
+-rw-r--r--   0 runner    (1001) docker     (122)      555 2023-06-21 08:04:05.540350 expectise-1.2.4/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (122)     6418 2023-06-21 08:03:47.000000 expectise-1.2.4/README.md
+drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-21 08:04:05.540350 expectise-1.2.4/expectise/
+-rw-r--r--   0 runner    (1001) docker     (122)      161 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (122)     1733 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/diff.py
+-rw-r--r--   0 runner    (1001) docker     (122)      403 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/exceptions.py
+-rw-r--r--   0 runner    (1001) docker     (122)    12936 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/expect.py
+-rw-r--r--   0 runner    (1001) docker     (122)      329 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/expectations.py
+-rw-r--r--   0 runner    (1001) docker     (122)     4126 2023-06-21 08:03:47.000000 expectise-1.2.4/expectise/mocks.py
+drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-21 08:04:05.540350 expectise-1.2.4/expectise.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (122)      555 2023-06-21 08:04:05.000000 expectise-1.2.4/expectise.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (122)      304 2023-06-21 08:04:05.000000 expectise-1.2.4/expectise.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (122)        1 2023-06-21 08:04:05.000000 expectise-1.2.4/expectise.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (122)       10 2023-06-21 08:04:05.000000 expectise-1.2.4/expectise.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (122)      175 2023-06-21 08:03:47.000000 expectise-1.2.4/pyproject.toml
+-rw-r--r--   0 runner    (1001) docker     (122)       79 2023-06-21 08:04:05.540350 expectise-1.2.4/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (122)      746 2023-06-21 08:03:47.000000 expectise-1.2.4/setup.py
```

### Comparing `expectise-1.2.3/PKG-INFO` & `expectise-1.2.4/PKG-INFO`
...
+Download-URL: https://github.com/tcassou/expectise/archive/1.2.4.tar.gz
...
### Comparing `expectise-1.2.3/README.md` & `expectise-1.2.4/README.md`

 * *Files identical despite different names*

### Comparing `expectise-1.2.3/expectise/diff.py` & `expectise-1.2.4/expectise/diff.py`

 * *Files identical despite different names*

### Comparing `expectise-1.2.3/expectise/expect.py` & `expectise-1.2.4/expectise/expect.py`
...
### Comparing `expectise-1.2.3/expectise/mocks.py` & `expectise-1.2.4/expectise/mocks.py`
...
### Comparing `expectise-1.2.3/expectise.egg-info/PKG-INFO` & `expectise-1.2.4/expectise.egg-info/PKG-INFO`
...
### Comparing `expectise-1.2.3/setup.py` & `expectise-1.2.4/setup.py`
